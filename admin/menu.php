...
<body>
    ...
    <h2 style="text-align: center; margin:10px;">Menu</h2>
...
<div>
        <label for="">Description</label>
            <input type="texr" name="des"  class="form-control">
</div>

<div>
        <label for="">Price</label>
            <input type="texr" name="price"  class="form-control">
</div>
      ...
      <div >
        <button type="submit" name="menu_submit">Save</button>
        </div>
      </form>
...
while($ans=mysqli_fetch_array($sq)){
        ...
        <tr>
            ...
            <td> <a href="mupdate.php?id=<?php echo $ans['id'] ?>">Update</a></td>
